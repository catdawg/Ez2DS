...
Searches the group for an element with an attribute equal to attr\-\_\-str.\-You should always destroy the result with e2d\-Scene\-Search\-Result\-Destroy() 

\begin{DoxySeeAlso}{See also}
e2d\-Scene\-Search\-Result\-Destroy() 
\end{DoxySeeAlso}
...
Searches the group for an element with an I\-D equal to id\-\_\-str. You should always destroy the result with e2d\-Scene\-Search\-Result\-Destroy() 
